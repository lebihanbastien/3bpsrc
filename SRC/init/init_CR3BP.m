...
%-------------------------------------------------------------------------%
% Initializes CR3BP (in particular the libration points)
%-------------------------------------------------------------------------%
% @param m1 the first primary name (string)
% @param m2 the second primary name (string)
% @param params the structure containing the user parameters
%
% @return the structure cr3bp (see within code)
