...
%%
% mex  -I/lib/gsl  CPPFLAGS="\$CPPFLAGS -static-libstdc++" -I∕C  ode78_qbcp.cpp   lib/libgsl.a lib/libgslcblas.a Cpp2/diffcorr.cpp Cpp2/pmcoc.cpp Cpp2/eminsem.cpp Cpp2/gnuplot_i.c Cpp2/nrutil.c Cpp2/single_orbit.cpp Cpp2/ode.cpp Cpp2/vf.cpp Cpp2/env.cpp Cpp2/FTA.cpp Cpp2/Oftsc.cpp Cpp2/Ofsc.cpp
