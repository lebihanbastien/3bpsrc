function out = bcfbp_derivatives_42(t,y, mu, theta0, ms, as, omegaS)
...
%
% OUT = BCFBP_DERIVATIVES_42(T, Y, MU, THETA0) computes the first-order
...
% AS and OMEGAS.
% On top of the 6-dimensionnal state, the 36 equations that govern the 
% evolution of the State Transition Matrix (STM) are also provided, for a
% total of 42 first-order equations of motion.
%
...
d2_ub = d2_u_b4(mu, ms, as, y(1),y(2),y(3), theta0+omegaS*t);
