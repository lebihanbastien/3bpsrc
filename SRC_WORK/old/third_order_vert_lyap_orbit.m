function yv_li =  third_order_vert_lyap_orbit(lyap, t)
...
Az_li = lyap.Az_estimate/gamma_i;
Ax_li = 0.0;
...
yv_li = richardson(Ax_li, Az_li, tau1, dtau1dt, dm, RC);
...
function yv_li = richardson(Ax_li, Az_li, tau1, dtau1dt, dm, RC)
