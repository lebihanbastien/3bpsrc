/*=========================================================================
 * ode78_cr3bp_event.c mex file to generate
        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    //---------------------------------------------------------------------
    if(nrhs!=4) {
        mexErrMsgIdAndTxt("custom:ode78_cr3bp_events:nrhs","4 inputs required.");
    }
    if(!(nlhs == 2 || nlhs == 4)) {
    ...
    //---------------------------------------------------------------------
    // Get input arguments
    mwSize nfields = mxGetNumberOfFields(prhs[3]);           //number of fields
    mwSize NStructElems = mxGetNumberOfElements(prhs[3]);    //number of elements (must be 1)
    ...
    //---------------------------------------------------------------------
    //Get the different fields in the event structure val_par = prhs[3]:
    // val_par.max_events
    // val_par.direction
    // val_par.dim
    // val_par.value
