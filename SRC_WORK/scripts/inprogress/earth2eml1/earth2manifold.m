...
% Year: 2015
%-------------------------------------------------------------------------%
function [ output, isSolution ] = earth2manifold(manifold_branch_stable, cr3bp,  earth, moon, user, params,  cst,  varargin)
%% Init
...
%     end
    ...
    if(abs(output.flyby.deltaV_dim) > 3) %Maneuver greater than 3 km/s
        disp('lfb. The Flyby maneuver is greater than 3 km/s. The solution is discarded');
        isSolution = false;
    end
