...
%Orbit
orbit_1 = init_orbit(cr3bp, cr3bp.l1,  cst.orbit.type.PLYAP, cst.orbit.family.PLANAR, 500, cst);
orbit_2 = init_orbit(cr3bp, cr3bp.l1,  cst.orbit.type.PLYAP, cst.orbit.family.PLANAR, 1000, cst);
...
for i = 1:maxIter
    ...
    waitbar(i / maxIter);
    period(i) = orbit_2.T;
    abscissa(i) = orbit_2.y0(1);
    Axdim(i) = orbit_2.Axdim;%y0(1);
end
% Close waitbar
close(h)
