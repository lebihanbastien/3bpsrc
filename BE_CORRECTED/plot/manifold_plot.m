...
% Termination point
if(isfield(manifold_branch, 'yve'))
%     for i = 1:size(manifold_branch.yve, 1)
%         plot3(manifold_branch.yve(i,1)*Lf, manifold_branch.yve(i,2)*Lf,manifold_branch.yve(i,3)*Lf, 'o', 'Color', color, 'MarkerFaceColor', color, 'LineWidth', 1.5, 'MarkerSize', 3.5);
%     end
    plot3(manifold_branch.yve(end,1)*Lf, manifold_branch.yve(end,2)*Lf,manifold_branch.yve(end,3)*Lf, 'o', 'Color', color, 'MarkerFaceColor', color, 'LineWidth', 1.5, 'MarkerSize', 3.5);
end
...
%         plot3(manifold_branch.yve(i,1)*Lf, manifold_branch.yve(i,2)*Lf,manifold_branch.yve(i,3)*Lf, 'o', 'Color', color, 'MarkerFaceColor', color, 'LineWidth', 1.5, 'MarkerSize', 3.5);
%     end
    plot3(manifold_branch.yve(end,1)*Lf, manifold_branch.yve(end,2)*Lf,manifold_branch.yve(end,3)*Lf, 'o', 'Color', color, 'MarkerFaceColor', color, 'MarkerSize', 4);
end
