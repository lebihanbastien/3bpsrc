...
% INIT_CR3BP initializes a given CR3BP system.
% 
% CR3BP = INIT_CR3BP(M1, M2, PARAMS) initializes a CR3BP whose primaries
% are defined by their names in string (M1, M2), M1 being the big primary 
% and M2 the small one (e.g. M1 = 'EARTH', M2 = 'MOON'). PARAMS is a
% structure of parameters is usually initialized by the routine 
% parameters_default_init
%
...
%
% See also parameters_default_init, init
% 
% BLB 2016
