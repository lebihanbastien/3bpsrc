...
% PARAMETERS_DEFAULT_INIT defines various default values for parameters used
% throughout the computations.
%
% DEFAULT = PARAMETERS_DEFAULT_INIT(CST) initializes various useful 
% parameters with default values, using constants nested in the structure 
% CST.
%       
% BLB 2016
...
default.plot.diff_corr       = true;  %during differential correction
